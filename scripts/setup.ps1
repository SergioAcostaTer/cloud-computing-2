...
aws firehose create-delivery-stream `
    ...
    --extended-s3-destination-configuration "BucketARN=arn:aws:s3:::$($env:BUCKET_NAME),RoleARN=$env:ROLE_ARN,Prefix=raw/,ErrorOutputPrefix=errors/,BufferingHints={SizeInMBs=1,IntervalInSeconds=60}"z